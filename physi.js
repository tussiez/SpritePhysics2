...
module.exports = function(THREE, Ammo) {
	...
	Physijs.Vehicle.prototype.addWheel = function(ObjectParams, wheel_geometry, wheel_material, connection_point, wheel_direction, wheel_axle, suspension_rest_length, wheel_radius, is_front_wheel, tuning ) {
		var wheel = new ObjectParams(new THREE.Mesh( wheel_geometry, wheel_material )); // edit ~tussiez: add objectparams
		wheel.castShadow = wheel.receiveShadow = true;
    wheel.params._doNotSimulate = true;
